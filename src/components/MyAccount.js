        ...
        return (
            <div className={`${ visible ? 'fixed':'hidden'} ${loading ? 'opacity-50':''}  fixed h-full w-full bg-gray-700 bg-opacity-50 justify-center`}>
               ...
               <select onChange={(e)=>{
                   ...
                   <option value='primary1a'>{french ? "Première année A":"Primary 1 A"}</option>
                   <option value='primary1b'>{french ? "Première année B":"Primary 1 B"}</option>
                   <option value='primary2a'>{french ? "Deuxième année A":"Primary 2 A"}</option>
                   <option value='primary2b'>{french ? "Deuxième année B":"Primary 2 B"}</option>
                   <option value='primary2c'>{french ? "Deuxième année C":"Primary 2 C"}</option>
                   <option value='primary2d'>{french ? "Deuxième année D":"Primary 2 D"}</option>
                   <option value='primary3a'>{french ? "Troisième année A":"Primary 3 A"}</option>
                   <option value='primary3b'>{french ? "Troisième année B":"Primary 3 B"}</option>

                   <option value='primary4a'>{french ? "Quatrième année A":"Primary 4 A"}</option>
                   <option value='primary4b'>{french ? "Quatrième année B":"Primary 4 B"}</option>
                   <option value='primary4c'>{french ? "Quatrième année C":"Primary 4 C"}</option>
                   <option value='primary5a'>{french ? "Cinquième année A":"Primary 5 A"}</option>
                   <option value='primary5b'>{french ? "Cinquième année B":"Primary 5 B"}</option>
                   <option value='primary5c'>{french ? "Cinquième année C":"Primary 5 C"}</option>
                   <option value='primary6a'>{french ? "Sixième année A":"Primary 6 A"}</option>
                   <option value='primary6b'>{french ? "Sixième année B":"Primary 6 B"}</option>
               </select>
